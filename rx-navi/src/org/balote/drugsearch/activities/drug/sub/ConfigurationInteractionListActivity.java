...
public class ConfigurationInteractionListActivity extends
		ExtendableDiseaseListActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.list_activity_configuration_interaction);
		...
		for (RoleModel rm : DrugInformationManager.getInstance()
			...
			if (rm.getRoleName().equalsIgnoreCase("CI_with")) {
